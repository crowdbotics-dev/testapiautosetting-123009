...
## Project Structure
    ...
    ├── testapiautosetting_123009  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123009`
...
2. Clone this repo and `cd testapiautosetting_123009`
